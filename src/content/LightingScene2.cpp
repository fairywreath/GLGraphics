#include "LightingScene2.h"

void LightingScene2::init()
{
    float vertices[] = {
    ...
    lightingShader.load("shaders/texture_lighting.vs.glsl", "shaders/texture_lighting.fs.glsl");
...
void LightingScene2::setCamera(FlyCamera* cam)
{
    camera = cam;
}

void LightingScene2::drawCurrent()
{
    if (camera == nullptr) {
        return;
    }
...
void LightingScene2::updateCurrent(float dt)
{
}
